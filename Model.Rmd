...
#Packages called rmarkdown and knitr is needed to produce html output from this Rmd file
...
```{r battery degradation rate function}
...
```{r Visualizantion of solar production}
...
```{r Visualiztion of load profile}
...
```{r visualize example 2 dispatch}
